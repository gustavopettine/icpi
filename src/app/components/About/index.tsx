export default function About() {
  return (
    <div id="sobre" className="max-w-7xl mx-auto pt-8">
          ...
          <div className="bg-white rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow duration-300 md:col-span-2">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-y-3 gap-x-4">
              <div className="flex items-center">
                ...
                <span className="text-zinc-600 text-sm">Sustentabilidade</span>
              </div>
              <div className="flex items-center">
                <span className="text-yellow-500 mr-2 mt-1 flex-shrink-0">
                  •
              ...
              <div className="flex items-center">
                ...
                <span className="text-zinc-600 text-sm">Qualidade efetiva</span>
              </div>
              <div className="flex items-center">
                <span className="text-yellow-500 mr-2 mt-1 flex-shrink-0">
                  •
